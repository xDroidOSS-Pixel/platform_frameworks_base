...
public class CommandQueue extends IStatusBar.Stub implements
    ...
    private static final int MSG_TOGGLE_SETTINGS_PANEL = 74 << MSG_SHIFT;
    private static final int MSG_SET_BLOCKED_GESTURAL_NAVIGATION = 75 << MSG_SHIFT;
    private static final int MSG_KILL_FOREGROUND_APP = 76 << MSG_SHIFT;
